...
runSQL($conn, "CREATE TABLE IF NOT EXISTS announcements (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", "announcements tablosu", $results, $hasError);
