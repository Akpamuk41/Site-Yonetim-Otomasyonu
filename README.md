...
Bu proje, apartman ve site komplekslerinin yönetimini dijital ortamda kolaylaştırmak amacıyla geliştirilmiş kapsamlı bir web uygulamasıdır. Sistem; blok, daire, sakin, aidat, ödeme, şikayet, gider ve duyuru yönetimi modüllerini tek bir platformda birleştirir. Veritabanı tarafında ilişkisel yapı, trigger, view, stored procedure ve index kullanılarak güçlü ve ölçeklenebilir bir mimari oluşturulmuştur.
...
├── residents.php               # Sakin listesi + PDF indirme
├── residents_pdf.php           # Sakin listesi PDF raporu (jsPDF)
...
├── announcements.php           # Duyuru yönetimi (admin)
...
├── install_db.php              # Tam veritabanı kurulum scripti
│
├── resident/                   # Sakin paneli
│   ├── index.php               # Sakin Dashboard (duyurular dahil)
...
│   └── announcements.php       # Duyurular (sakin görünümü)
│
...
├── grupno_sql_betikleri.txt    # Teslim: SQL betikleri
├── grupno_kaynakkod.txt        # Teslim: Kaynak kodlar
├── grupno_github.txt           # Teslim: GitHub linki
└── README.md                   # Bu dosya
```
...
| Sakinler | Sakin kayıtları, arama filtresi, sakin silme, PDF rapor indirme |
...
| Duyurular | Duyuru ekleme, aktif/pasif yönetimi, öncelik seviyeleri |

### 7.3 Sakin Paneli

| Sayfa | Açıklama |
|-------|----------|
| Ana Sayfa | Aidat özeti, son ödemeler, aktif duyurular |
...
| Duyurular | Yönetimden gelen aktif duyurular (normal/önemli/acil) |
...
| **Sakin Yönetimi** | Sakin ekleme/silme, daire atama, PDF rapor indirme |
| **Aidat Yönetimi** | Aidat ekleme, borç takibi, ödeme durumu |
| **Ödeme Yönetimi** | Nakit/kart/havale ödeme kaydı, kart simülasyonu |
...
| **Duyuru Yönetimi** | Duyuru ekleme, öncelik seviyeleri (normal/önemli/acil), aktif/pasif yönetimi |

### 9.2 Veritabanı Özeti

| Yapı | Adet | Açıklama |
|------|------|----------|
| Tablo | 9 | blocks, apartments, residents, dues, payments, complaints, expenses, users, announcements |
| Index | 11 | Composite index dahil performans optimizasyonu |
| View | 4 | v_payment_details, v_apartment_summary, v_complaint_details, v_financial_summary |
| Trigger | 4 | Ödeme ve sakin işlemlerinde otomatik güncelleme |
| Stored Procedure | 4 | Gelir hesaplama, aidat listeleme, gider ekleme, şikayet güncelleme |

### 9.3 Gelecek Geliştirmeler

- [x] Duyuru yönetimi sistemi
- [x] Sakin silme özelliği
- [x] PDF rapor indirme
- [x] Aidat tutarı doğrulama (ne az ne fazla)
